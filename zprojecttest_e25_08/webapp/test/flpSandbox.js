		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Chart",
									"targetURL": "#zprojectteste2508-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zprojectteste2508-display": {
								"semanticObject": "zprojectteste2508",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zprojectteste2508",
									"url": sap.ui.require.toUrl("zprojectteste2508")
								}
							}
						}
					}
