		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "다면평가",
									"targetURL": "#zcbcprojectemprating-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zcbcprojectemprating-display": {
								"semanticObject": "zcbcprojectemprating",
								"action": "display",
								"description": "다면평가",
								"title": "다면평가",
								"signature": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zcbcprojectemprating",
									"url": sap.ui.require.toUrl("zcbcprojectemprating")
								}
							}
						}
					}
