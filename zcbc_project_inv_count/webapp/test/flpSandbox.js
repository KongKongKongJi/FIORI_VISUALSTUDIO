		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "재고 실사 처리",
									"targetURL": "#zcbcprojectinvcount-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zcbcprojectinvcount-display": {
								"semanticObject": "zcbcprojectinvcount",
								"action": "display",
								"description": "재고실사",
								"title": "재고 실사 처리",
								"signature": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zcbcprojectinvcount",
									"url": sap.ui.require.toUrl("zcbcprojectinvcount")
								}
							}
						}
					}
