		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Northwind",
									"targetURL": "#ntzprojectodatae2503-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ntzprojectodatae2503-display": {
								"semanticObject": "ntzprojectodatae2503",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=nt.zprojectodatae2503",
									"url": sap.ui.require.toUrl("nt/zprojectodatae2503")
								}
							}
						}
					}
